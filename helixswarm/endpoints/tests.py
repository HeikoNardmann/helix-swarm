    ...
    def get(self,
        ...
        Args:
            fields (Optional[List[str]]):
                An optional list of fields to show for each test. Omitting
            ...
            noCache (Optional[bool]):
                ...
                performed and the cache of tests is ignored. Otherwise the
        ...
        return self.swarm._request('GET', 'testdefinitions', params=params)
